...
describe('<SelfExclusionArticle />', () => {
    ...
    const non_eu_item =
        /these self-exclusion limits help you control the amount of money and time you spend trading on deriv trader, Binarytool Bot, smarttrader and binary bot on deriv. the limits you set here will help you exercise/i;
