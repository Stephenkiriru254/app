...
export const D_ALEMBERT: TDescriptionItem[] = [
    {
        type: 'subtitle',
        content: [localize('Exploring the D’Alembert strategy in Binarytool Bot')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for D’Alembert strategy in Binarytool Bot.')],
    },
    {
        type: 'text',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '4. If the second trade results in a loss, the Binarytool Bot will automatically increase your stake for the next trade by 2 USD. Binarytool Bot will continue to add 2 USD to the previous round’s stake after every losing trade. See A2.'
            ),
            localize(
    ...
    },
    {
        ...
        content: [
            localize(
                "The D'Alembert system offers more balanced trading through controlled stake progression. With prudent risk management like stake limits, it can be effectively automated in Binarytool Bot. However, traders should thoroughly assess their risk appetite, test strategies on a demo account to align with their trading style before trading with real money. This allows optimising the approach and striking a balance between potential gains and losses whilst managing risk."
            ),
        ],
    },
    {
