...
export const OSCARS_GRIND: TDescriptionItem[] = [
    {
        type: 'subtitle',
        content: [localize('Exploring the Oscar’s Grind strategy in Binarytool Bot')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for Oscar’s Grind strategy in Binarytool Bot.')],
    },
    {
        type: 'text',
        content: [
