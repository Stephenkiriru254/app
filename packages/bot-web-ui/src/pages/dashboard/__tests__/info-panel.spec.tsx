...
describe('InfoPanel', () => {
    ...
    it('should render the InfoPanel component', () => {
        ...
        expect(screen.getByText('Welcome to Binarytool Bot!')).toBeInTheDocument();
    });
    ...
    it('should render the switching of tabs upon clicking the text link', () => {
        ...
        const guide_tab = screen.getByText('Binarytool Bot - your automated trading partner');
    ...
    it('should render the tutorial tab and FAQ tab', () => {
        ...
        const faq_tab = screen.getByText('What is Binarytool Bot?');
